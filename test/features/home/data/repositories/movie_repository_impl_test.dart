...
void main(){
  ...
  List<Movie> tListMovie = tListMovieModel;
  ...
  group('getTrendingMovies', (){
    ...
    test(
      ...
      () async {
        ...
        when(() => mockMovieLocalDatasource.cacheTrendingMovies(tListMovieModel)).thenAnswer((_) async => Future.value(false));
    ...
    group('device is online', (){
      ...
      test(
        ...
        () async {
          ...
          //assert
          verify(() => mockMovieRemoteDatasource.getTrendingMovies(tTimeWindow)).called(1);
      ...
      test(
        ...
        () async {
          ...
          //assert
          verify(() => mockMovieRemoteDatasource.getTrendingMovies(tTimeWindow)).called(1);
          verify(() => mockMovieLocalDatasource.cacheTrendingMovies(tListMovieModel)).called(1);          
    ...
    group('device is offline', (){
      ...
      test(
        ...
        () async {
          //arrange
          when(() => mockMovieLocalDatasource.getTrendingMoviesFromLocalDatasource())
            .thenAnswer((_) async => tListMovieModel);
          //act
          final result = await repository.getTrendingMovies(tTimeWindow);
          ...
          //assert
          verify(()=> mockNetworkInfo.isConnected).called(1);
          verify(()=> mockMovieLocalDatasource.getTrendingMoviesFromLocalDatasource()).called(1);
          verifyZeroInteractions(mockMovieRemoteDatasource);

          expect(result, Right(tListMovieModel));
